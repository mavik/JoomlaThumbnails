...
class ImageWithThumbnailsTest extends TestCase
{
    ...
    public function testCreate()
    {
        ...
        $thumb3 = __DIR__ . '/../temp/apple-3-fit.jpg';
        $thumb1Sample = __DIR__ . '/../resources/images/resized/apple-100-200-fill.jpg';
        $thumb2Sample = __DIR__ . '/../resources/images/resized/apple-150-300-fill.jpg';
        $thumb3Sample = __DIR__ . '/../resources/images/resized/apple-200-400-fill.jpg';
        ...
        $this->assertEquals(150, $thumbnails['1.5']->getWidth());
        $this->assertEquals(300, $thumbnails['1.5']->getHeight());
        ...
        unlink($thumb1);
        $thumbnails['1.5']->save($thumb2);
        $this->assertLessThan(1, CompareImages::distance($thumb2, $thumb2Sample));
        unlink($thumb2);
        $thumbnails[2]->save($thumb3);
        $this->assertLessThan(1, CompareImages::distance($thumb3, $thumb3Sample));
        unlink($thumb3);
    }
